  ...
  return (
    <section id="eeat-garantia" className="py-20 bg-blue-50 dark:bg-gray-900 border-t border-blue-100 dark:border-gray-800">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeUpVariant} className="inline-block px-4 py-2 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-full text-[11px] font-bold text-indigo-500 uppercase tracking-widest mb-6 shadow-sm">
          ...
          <motion.h2 variants={fadeUpVariant} className="font-header font-extrabold text-4xl sm:text-5xl mb-4 text-gray-800 dark:text-gray-100">
            Respaldo <span className="text-indigo-500">Genético</span> & Compromiso Veterinario
          </motion.h2>
        ...
        >
          ...
          <motion.div variants={fadeUpVariant} className="playful-card bg-white dark:bg-gray-800 h-full flex flex-col items-center text-center p-8">
            <div className="w-14 h-14 rounded-full bg-blue-50 dark:bg-gray-700 text-indigo-500 flex items-center justify-center mb-6 shadow-sm">
