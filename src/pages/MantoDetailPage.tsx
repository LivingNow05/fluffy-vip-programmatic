    ...
    <main className="max-w-[1100px] mx-auto px-4 sm:px-6 mt-8 mb-20 animate-fade-in">
      ...
      <article className="grid md:grid-cols-2 gap-10 lg:gap-14 items-center mb-16">
        ...
        <div>
          ...
          <div className="inline-block bg-lavender-mist dark:bg-gray-800 text-cornflower dark:text-cornflower font-mono font-bold text-sm px-4 py-2 rounded-xl mb-6 border border-cornflower/20">
            {manto.genetica}
          </div>
